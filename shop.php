...
<body>
  <div class="page-wrapper">
    ...
    <main class="main">
      ...
      <div class="page-content">
        <div class="categories-page shop_page">
              ...
              <div class="row">
                ...
                if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<div class="banner banner-overlay">';
                    echo '<a href="product-internal.php?product_id=' . $productId . '">';
                    echo '<img src="./uploads/' . $productImage . '" alt="' . $productName . '">';
                    echo '</a>';
                    echo '<div class="banner-content banner-content-bottom">';
                    echo '<h3 class="banner-title text-white">' . $productName . '</h3>';
                    echo '<div class="banner-text text-white">from $' . number_format($productPrice, 2) . '</div>';
                    echo '<a href="product-internal.php?product_id=' . $productId . '" class="btn btn-outline-white banner-link">Shop Now<i class="icon-long-arrow-right"></i></a>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
                  }
    ...
    <footer class="footer footer-2">
          ...
          <div class="row">
            <div class="col-sm-12 col-lg-6">
              <div class="widget widget-about">
                ...
                <p>
                  The name of reliance in Marketing Printing & Advertising. Developing innovative
                  ideas Gifts & Gimmicks etc. Beside some multifarious work in Fine Arts like Urdu
                  Poetry, Calligraphy Arabic & English, Painting, Portrait Pencil Sketching,
                  Modeling and many many more. Book writing on different subjects.
                </p>
      ...
      <div class="footer-bottom">
        <div class="container">
          <p class="footer-copyright">Copyright © 2019 Aly Ahmad Shah. All Rights Reserved.</p>
          ...
          <div class="form-box">
            <div class="form-tab">
              <ul class="nav nav-pills nav-fill" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="signin-tab" data-toggle="tab" href="#signin" role="tab" aria-controls="signin" aria-selected="true">
                    Sign In
                  </a>
                </li>
                <li class="nav-item">
  ...
  <script>
    (function() {
      var js =
        "window['__CF$cv$params']={r:'811f20a2ad57f0df',t:'MTY5NjYwODEzMy42NDkwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../cdn-cgi/challenge-platform/h/g/scripts/jsd/dffb14d6/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";
...
<!-- Mirrored from portotheme.com/html/molla/product-category-boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Oct 2023 16:16:14 GMT -->
