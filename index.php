          ...
          >
            ...
            >
              <div class="container intro-content">
                <h3 class="intro-subtitle">Art</h3>
                <h1 class="intro-title">Fine Arts & Calligraphy</h1>
            ...
            >
              <div class="container intro-content">
                ...
                <h1 class="intro-title">Portrait Pencil Sketching</h1>
            ...
            >
              <div class="container intro-content">
                ...
                <h1 class="intro-title">Innovative Ideas Gifts & Gimmicks</h1>
...
<section class="hero_section">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <h2>Crafted Elegance in Every Stroke With Calligraphy</h2>
        <p>The name of reliance in Marketing Printing & Advertising. Developing innovative ideas Gifts & Gimmicks etc. Beside some multifarious work in Fine Arts like Urdu Poetry, Calligraphy Arabic & English, Painting, Portrait Pencil Sketching, Modeling and many many more. Book writing on different subjects.</p>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8 col-md-6 col-12">
                <div class="call-content essential-cta-content text-center text-sm-start">
                    <h3 class="text-white wow move-up animate">Let’s create something extraordinary together.</h3>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12">
                <div class="call-btn text-center text-md-end mt_mobile--20 wow move-up animate">
                    <a class="brook-btn bk-btn-white text-theme btn-sd-size essential-btn" href="#"> Join us now </a>
                </div>
            </div>
        </div>
    </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay">
                  ...
                  <div class="banner-content banner-content-bottom">
                    ...
                    <h3 class="banner-title text-white">Calligraphy</h3>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay">
                  <a href="#">
                    <img src="assets/images/cal-4.jpg" alt="Banner" />
                  </a>
...
<section class="product_catogaries banner-group">
  <div class="container">
    <h2 class="title text-center mb-3">Categories of Sketching</h2><!-- End .title mb-2 -->

    <div class="row justify-content-center">
      <div class="col-md-6 col-lg-4">
        <div class="banner banner-cat">
          <a href="#">
            <img src="assets/images/5.jpg" alt="Banner">
          </a>

          <div class="banner-content banner-content-overlay text-center">
            <h3 class="banner-title">Calligraphy</h3><!-- End .banner-title -->
      ...
      <div class="col-md-6 col-lg-4">
        <div class="banner banner-cat">
          <a href="#">
            <img src="assets/images/6.jpg" alt="Banner">
          </a>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="banner banner-cat">
          <a href="#">
            <img src="assets/images/7.webp" alt="Banner">
          </a>
...
<section>
  <div class="footer-newsletter bg-image" style="background-image: linear-gradient(240deg, #000, #000000ac), url(assets/images/bg.jpg)">
    <div class="container">
      <div class="heading text-center">
        <h3 class="title">Inspiration Newsletter Sparks Unleashed</h3>
        <!-- End .title -->
        <p class="title-desc">
    ...
    <section class="contact_section">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 mb-2 mb-lg-0">
              ...
              <p class="mb-3">Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui</p>
              <div class="row">
                <div class="col-sm-7">
                  <div class="contact-info">
                    ...
                    <ul class="contact-list">
                      ...
                      <li>
                        ...
                        <a href="https://portotheme.com/cdn-cgi/l/email-protection#e1c2"><span class="__cf_email__" data-cfemail="cea7a0a8a18e83a1a2a2afe0ada1a3">[email&#160;protected]</span></a>
                      </li>
                    </ul><!-- End .contact-list -->
      ...
      <section class="faq_sec">
       <div class="container">
        <h2 class="title text-center mb-3">Frequently Asked Question</h2><!-- End .title -->
   ...
   <div class="cta cta-display bg-image pt-4 pb-4" style="background-image: url(assets/images/backgrounds/cta/bg-7.jpg);">
    ...
    <script>
      (function () {
        var js =
          "window['__CF$cv$params']={r:'811d14cdcb723c75',t:'MTY5NjU4NjY3Ny43OTkwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../cdn-cgi/challenge-platform/h/g/scripts/jsd/dffb14d6/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";
